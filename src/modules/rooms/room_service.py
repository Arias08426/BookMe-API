...
class RoomService:
    ...
    def create_room(self, nombre: str, capacidad: int, ubicacion: str) -> Room:
        ...
        return self.repository.create(nombre=nombre, capacidad=capacidad, ubicacion=ubicacion)
    ...
    def update_room(self, room_id: int, nombre: str, capacidad: int, 
                    ubicacion: str, activa: bool) -> Room:
        """
    ...
    def delete_room(self, room_id: int) -> None:
        ...
        future_reservations = self.db.query(Reservation).filter(
    ...
    def get_availability(self, room_id: int, target_date: date) -> dict:
        ...
        # Verificar caché
        cache_key = self.cache.get_cache_key("availability", str(room_id), str(target_date))
