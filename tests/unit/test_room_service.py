...
class TestRoomService:
    ...
    def test_create_room_success(self, test_db):
        ...
        room = service.create_room(
            nombre="Sala A1", capacidad=10, ubicacion="Edificio Principal"
        )
    ...
    def test_create_room_invalid_capacity(self, test_db):
        ...
        with pytest.raises(ValueError) as exc_info:
            service.create_room(
                nombre="Sala Inválida", capacidad=0, ubicacion="Algún lugar"
            )
    ...
    def test_update_room_success(self, test_db):
        ...
        # Crear sala
        room = service.create_room(
            nombre="Sala Original", capacidad=5, ubicacion="Piso 1"
        )
    ...
    def test_delete_room_without_reservations(self, test_db):
        ...
        # Crear sala
        room = service.create_room(
            nombre="Sala Temporal", capacidad=8, ubicacion="Piso 3"
        )
